    ...
    <>
      ...
      <main className='p-16 flex flex-col items-center'>
        ...
        <section className='pitch py-8 w-full flex flex-col items-center gap-4'>
            ...
            <p className='w-full md:w-1/2 md:pl-4'>I enjoy working on UI, and I can create a beautiful UI for you. I'm eager to work on the frontend component of it in partnership with a business or individual. Additionally, I'm interested in freelancing. Let's discuss more!</p>
